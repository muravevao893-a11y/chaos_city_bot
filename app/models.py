...
class City(Base):
    ...
    activity_mode: Mapped[str] = mapped_column(String(20), default="normal", nullable=False)
...
class Membership(Base):
    ...
    secret_role: Mapped[str | None] = mapped_column(String(32), nullable=True)
    mission_key: Mapped[str | None] = mapped_column(String(32), nullable=True)
    mission_started_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    mission_completed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    last_revolt_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
